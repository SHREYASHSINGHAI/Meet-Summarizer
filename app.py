...
try:
    ...
    try:
        ...
        pass # This will be caught when pydub tries to load

# 2. Now perform your standard imports
...
def preprocess_audio(input_path, output_path):
    ...
    chunks = split_on_silence(
        audio, 
        min_silence_len=1500, # Increased slightly for better speed
        silence_thresh=-40, 
        keep_silence=200
    )
...
if uploaded_file:
    ...
    if st.button("Generate Insights"):
        ...
        with st.spinner("1. Transcribing Audio (Whisper)..."):
            # cache_resource could be added here later for more speed
